                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            <div class="d-inline-block align-middle">
                                                <img src="admin/assets/images/user/avatar-4.jpg" alt="user image" class="img-radius wid-40 align-top m-r-15">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div class="d-inline-block align-middle">
                                                <img src="admin/assets/images/user/avatar-2.jpg" alt="user image" class="img-radius wid-40 align-top m-r-15">
                                                <div class="d-inline-block">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div class="d-inline-block align-middle">
                                                <img src="admin/assets/images/user/avatar-3.jpg" alt="user image" class="img-radius wid-40 align-top m-r-15">
                                                <div class="d-inline-block">
                                                    <h6>William Jem</h6>
                        ...
                        <div class="review-block">
                            <div class="row">
                                <div class="col-sm-auto p-r-0">
                                    <img src="admin/assets/images/user/avatar-2.jpg" alt="user image" class="img-radius profile-img cust-img m-b-15">
                                </div>
                                <div class="col">
                            ...
                            <div class="row">
                                <div class="col-sm-auto p-r-0">
                                    <img src="admin/assets/images/user/avatar-4.jpg" alt="user image" class="img-radius profile-img cust-img m-b-15">
                                </div>
                                <div class="col">
